...
showType = function(url){
  ...
  if(loadedJson){
    if(!loadedJson['@context'] || !loadedJson['@id']){
      ...
      content.innerHTML += "<h2>PEAT Type:</h2><p class='box'>" + loadedJson._id +
...
showObject = function(url){
  ...
  if(loadedJson){
    content.innerHTML += "<h2>PEAT Object:</h2><p class='box'>" + url + "</p>";
    content.innerHTML += "<h2>PEAT Type:</h2><p class='box'><a target='_blank' href='" + loadedJson['@type'] + "'>" + loadedJson['@type'] + "</a></p>";
    content.innerHTML += "<h2>PEAT Revision:</h2><p class='box'>" + loadedJson['_revision'] + "</p>";
